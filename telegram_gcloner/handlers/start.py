...
def start(update, context):
    rsp = update.message.reply_text('🔺 আপনার সার্ভিস একাউন্ট (SA) গুলো জিপ করে জিপ ফাইলটি আমাকে দিন এবং আপলোড করার সময় সাবজেক্ট এ /sa লিখে দিন\n'
                                    '📂 এরপর আপনার আপলোড ফোল্ডার সেট করুন, /folders কমান্ডের মাধ্যমে\n'
                                    '🔗 সব কনফিগার করা হলে শুধু গুগল ড্রাইভ লিংক সেন্ড/ ফরোয়াড করলেই ফাইল ক্লোন করতে পারবেন.')
